...
async def startup_event():
    ...
    logger.info("  [x] HMM for Environmental States")
    logger.info("  [x] Monte Carlo Simulation (10,000 iterations)")
    logger.info("  [x] A* Pathfinding with Residential Penalty")
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("\nFeatures:")
    print("  [x] LSTM neural network for traffic prediction")
    print("  [x] Real-time NYC DOT traffic data via Socrata API")
    print("  [x] Emissions and health impact modeling")
    print("  [x] Speed limit scenario comparison (50mph vs 60mph)")
    print("  [x] Hidden Markov Model for Environmental States")
    print("  [x] Monte Carlo Simulation for Uncertainty")
    print("  [x] A* Pathfinding for Residential Diversion")
    print("\nAPI Endpoints:")
